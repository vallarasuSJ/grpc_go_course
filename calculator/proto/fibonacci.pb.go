...
type FibRequest struct {
	...
	FibNumber int32 `protobuf:"varint,1,opt,name=fibNumber,proto3" json:"fibNumber,omitempty"`
}
...
func (x *FibRequest) GetFibNumber() int32 {
	if x != nil {
		return x.FibNumber
	}
	return 0
...
func (x *FibResponse) GetResult() int32 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_fibonacci_proto_rawDesc = []byte{
	...
	0x0a, 0x46, 0x69, 0x62, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x66,
	0x69, 0x62, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09,
	0x66, 0x69, 0x62, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x25, 0x0a, 0x0b, 0x46, 0x69, 0x62,
	...
	0x61, 0x6c, 0x6c, 0x61, 0x72, 0x61, 0x73, 0x75, 0x53, 0x4a, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x5f,
	0x67, 0x6f, 0x5f, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x2f, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c,
...
var file_fibonacci_proto_goTypes = []interface{}{
	(*FibRequest)(nil),  // 0: calculator.FibRequest
	(*FibResponse)(nil), // 1: calculator.FibResponse
}
